...
public class StatThreadAverages implements Runnable {

	
	// Changeable Variables
	private final String CreatedStat = "Averages" ;
	...
	public StatThreadAverages( String FileName , BigInteger SampleSize ) throws FileNotFoundException {
	...
	private void StatCreationTick() throws IOException {
		...
		ArrayFile.Access( BigInteger.valueOf(-1) , DiceRoller.CreateAverage()+"" ) ; //Number Creation Method for Analysis
