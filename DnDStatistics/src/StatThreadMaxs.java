...
public class StatThreadMaxs implements Runnable {

	
	// Changeable Variables
	private final String CreatedStat = "Maximums" ;
	...
	public StatThreadMaxs( String FileName , BigInteger SampleSize ) throws FileNotFoundException {
	...
	private void StatCreationTick() throws IOException {
		...
		ArrayFile.Access( BigInteger.valueOf(-1) , DiceRoller.CreateMaximum()+"" ) ;
