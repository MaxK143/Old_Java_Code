...
public class StatThreadMins implements Runnable {

	
	// Changeable Variables
	private final String CreatedStat = "Minimums" ;
	...
	public StatThreadMins( String FileName , BigInteger SampleSize ) throws FileNotFoundException {
	...
	private void StatCreationTick() throws IOException {
		...
		ArrayFile.Access( BigInteger.valueOf(-1) , DiceRoller.CreateMinimum()+"" ) ;
