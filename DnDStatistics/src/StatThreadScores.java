...
public class StatThreadScores implements Runnable {

	
	// Changeable Variables
	private final String CreatedStat = "Scores" ;
	
	private final double OccuranceIteration = 20 ;
	
	private final double MaxValue = 324 ;
	
	private double TrailingNum = 17.5 ;
	
	private double LeadingNum = TrailingNum + 6.5 + OccuranceIteration ;
	...
	public StatThreadScores( String FileName , BigInteger SampleSize ) throws FileNotFoundException {
	...
	private void StatCreationTick() throws IOException {
		...
		ArrayFile.Access( BigInteger.valueOf(-1) , DiceRoller.CreateScore()+"" ) ;
